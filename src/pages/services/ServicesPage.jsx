    ...
    return (
        <section>
            ...
            <div className="px-10 md:px-31.25 pb-24 pt-15 md:pt-58.5 flex flex-col items-center justify-center gap-10 md:gap-15 bg-brand-primary ">
                <TextSection titleKey={content.monthly.title} subtitleKey={content.monthly.intro} variant='dark' direction="col" alignment="left" subtitleClassName="max-w-150" contentClassName="flex-col md:flex-row gap-8.75 md:!items-center px-5" />
