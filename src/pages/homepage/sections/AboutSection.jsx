...
export const AboutSection = () => {
    ...
    return (
        <section className="w-full h-auto bg-white flex flex-col md:flex-row items-center justify-center gap-12.5 py-15 px-15 md:px-0 md:py-24 ">
            ...
            <TextSection as="h2" titleKey={content.title} subtitleKey={content.subtitle} variant="lightRed" contentClassName="gap-10 py-10 md:py-0" subtitleClassName="max-w-165" className="max-w-158" alignment="left" />
        </section>
    )
}