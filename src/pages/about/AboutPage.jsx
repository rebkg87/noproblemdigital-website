    ...
    return (
        <section>
            ...
            <div className="bg-brand-primary px-15 md:px-31.25 py-20 flex flex-col gap-15 md:gap-30 md:py-30 ">
                    <TextSection as="h2" titleKey={content.team.section1.title} subtitleKey={content.team.section1.subtitle} variant="dark" direction="col" alignment="left" subtitleClassName="max-w-170" contentClassName="gap-8.75"/>
                    <TextSection as="h2" titleKey={content.team.section2.title} subtitleKey={content.team.section2.subtitle} variant="darkInverse" direction="col" alignment="right" subtitleClassName="max-w-200" contentClassName="gap-8.75"/>
                </div>
        </section>
    )
}